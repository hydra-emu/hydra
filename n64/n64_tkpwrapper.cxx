...
uint32_t get_key_number(std::string key_s) {
	if (key_s == "A") return hydra::N64::Keys::A;
	if (key_s == "B") return hydra::N64::Keys::B;
	if (key_s == "Z") return hydra::N64::Keys::Z;
	if (key_s == "Start") return hydra::N64::Keys::Start;
	if (key_s == "Up") return hydra::N64::Keys::Up;
	if (key_s == "Down") return hydra::N64::Keys::Down;
	if (key_s == "Left") return hydra::N64::Keys::Left;
	if (key_s == "Right") return hydra::N64::Keys::Right;
	if (key_s == "L") return hydra::N64::Keys::L;
	if (key_s == "R") return hydra::N64::Keys::R;
	if (key_s == "CUp") return hydra::N64::Keys::CUp;
	if (key_s == "CDown") return hydra::N64::Keys::CDown;
	if (key_s == "CLeft") return hydra::N64::Keys::CLeft;
	if (key_s == "CRight") return hydra::N64::Keys::CRight;
...
namespace hydra::N64 {
	...
	void N64_TKPWrapper::update() {
		try {
			...
			fmt::print("{}\n{}\n", ex.what(), boost::stacktrace::to_string(boost::stacktrace::stacktrace()));
