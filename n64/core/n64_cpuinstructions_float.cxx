...
namespace hydra::N64 {
    ...
    bool CPU::check_fpu_exception() {
        ...
        if (fcr31_.unimplemented) {
            ...
            (fcr31_.cause_inexact && fcr31_.enable_inexact) ||
    ...
    void CPU::f_CULT() {
        switch (fmtval) {
            case FMT_S: {
                fcr31_.compare = fsreg.FLOAT._0 < ftreg.FLOAT._0 || (std::isnan(fsreg.FLOAT._0) || std::isnan(ftreg.FLOAT._0));
                break;
            }
            case FMT_D: {
                fcr31_.compare = fsreg.DOUBLE < ftreg.DOUBLE || (std::isnan(fsreg.DOUBLE) || std::isnan(ftreg.DOUBLE));
                break;
            }
            default:
