...
namespace hydra::N64 {
    ...
    const static std::array<std::string, 64> OperationCodes = {
        "nop", "regimm", "j", "jal", "beq", "bne", "blez", "bgtz",
    ...
    enum class InstructionType {
        ...
        ADDI, ADDIU, SLTI, STLIU, ANDI, ORI, XORI, LUI,
        COP0, COP1, COP2, _23ERR, BEQL, BNEL, BLEZL, BGTZL,
        DADDI, DADDIU, LDL, LDR, _34ERR, _35ERR, _36ERR, _37ERR,
        LB, LH, LWL, LW, LBU, LHU, LWR, LWU,
        SB, SH, SWL, SW, SDL, SDR, SWR, CACHE,
        LL, LWC1, LWC2, _63ERR, LLD, LDC1, LDC2, LD,
        SC, SWC1, SWC2, _73ERR, SCD, SDC1, SDC2, SD,
        
        s_SLL, _S2ERR, s_SRL, s_SRA, s_SLLV, _S5ERR, s_SRLV, s_SRAV,
        s_JR, s_JALR, _S12ERR, _S13ERR, s_SYSCALL, s_BREAK, _S16ERR, s_SYNC,
        s_MFHI, s_MTHI, s_MFLO, s_MTLO, s_DSLLV, _S25ERR, s_DSRLV, s_DSRAV,
        s_MULT, s_MULTU, s_DIV, s_DIVU, s_DMULT, s_DMULTU, s_DDIV, s_DDIVU,
        s_ADD, s_ADDU, s_SUB, s_SUBU, s_AND, s_OR, s_XOR, s_NOR,
        _S50ERR, _S51ERR, s_SLT, s_SLTU, s_DADD, s_DADDU, s_DSUB, s_DSUBU,
        s_TGE, s_TGEU, s_TLT, s_TLTU, s_TEQ, _S65ERR, s_TNE, _S67ERR,
        s_DSLL, _S71ERR, s_DSRL, s_DSRA, s_DSLL32, _S75ERR, s_DSRL32, s_DSRA32,

        NOP,
        ERROR
    };
    static std::string gpr_get_name(int n, bool register_names) {
        if (register_names) {
            switch (n) {
                case 0:
                    return "zero";
