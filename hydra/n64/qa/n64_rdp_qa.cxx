...
protected:
    ...
    void PrintCommand(const std::vector<uint64_t> triangle) {
        ...
        printf("slopel: %d.%d slopem: %d.%d slopeh: %d.%d\n", slopel >> 16, slopel & 0xffff, slopem >> 16, slopem & 0xffff, slopeh >> 16, slopeh & 0xffff);
    }
...
TRIANGLE_TEST(Simple_Triangle, 0x088002a801180118, 0x00d20000ffff0000, 0x006e000000000000, 0x006e000000000000);

TRIANGLE_TEST(Simple_Triangle_Flipped, 0x080002a801180118, 0x006e000000010000, 0x00d2000000000000, 0x00d2000000000000);

TRIANGLE_TEST(Simple_Triangle_Using_YM, 0x08800300016c0118, 0x00d20000ffff0000, 0x006e000000000000, 0x006e00000004c000);

TRIANGLE_TEST(Slopes_L_H_Intersect_Before_YM_YL, 0x088002a8016800f0, 0x00c80000ffff0000, 0x005a000000010000, 0x00780000ffff0000);

TRIANGLE_TEST(Slopes_L_M_Intersect, 0x088002a8011800a0, 0x00d20000ffff0000, 0x006e00000000e000, 0x006e00000004a000);

TRIANGLE_TEST(Slopes_L_M_Intersect_Flipped, 0x080002a8011800a0, 0x006e000000010000, 0x00d20000ffff8000, 0x00d20000fffb4000);

TRIANGLE_TEST(Same_XH_XM_XL, 0x088002bc02bc0258, 0x00e1000000000000, 0x00e10000fffe0000, 0x00e1000000000000);
