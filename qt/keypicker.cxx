...
KeyPickerPage::KeyPickerPage(QWidget* parent) : QWidget(parent)
{
    ...
    //     j++;
    // }
    // connect(table, SIGNAL(cellDoubleClicked(int, int)), this, SLOT(onCellDoubleClicked(int,
    // int))); tab_show_->addTab(table, QString::fromStdString("Default mappings"));
    ...
    // onComboBoxChange(0);
    // connect(emulator_picker_, SIGNAL(currentIndexChanged(int)), this,
    // SLOT(onComboBoxChange(int)));
}
